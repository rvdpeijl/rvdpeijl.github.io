...
App = React.createClass({displayName: "App",
  render: function() {
    return React.createElement("div", null, React.createElement(Terminal, null));
  }
});

document.addEventListener('DOMContentLoaded', function() {
  return React.render(React.createElement(App, null), document.getElementById('hook'));
});


},{"./js/terminal/terminal.coffee":158,"react":156}],158:[function(require,module,exports){
var React, Terminal;

React = require('react');

Terminal = React.createClass({displayName: "Terminal",
  render: function() {
    return React.createElement("div", {
      ...
      "id": "window"
    }, React.createElement("span", null, "\x3E @fullName()"), React.createElement("span", {
      "className": "output"
    }, "\"Robbin van der Peijl\""), React.createElement("span", null, "\x3E @getSkillz()"), React.createElement("span", {
      "className": "output"
    }, "undefined"), React.createElement("span", null, "\x3E @getSkills()"), React.createElement("span", {
      "className": "output"
    }, "[\'JavaScript\', \'Node\', \'React\', \'Flux\', \'Less\']")));
  }
});
